function visualize(t, o, theta, odes, moviefile)
%
%   t           time (1xM)
...
o_RoomInDisplay = [0;0;0];
R_RoomInDisplay = [1   0        0;
                   0 cos(pi) -sin(pi);
                   0 sin(pi) cos(pi)];
...
% pBodyFrame_InBody
% pQuad_InBody
for i=1:length(pQuad_InBody)
    
pQuad_InRoom(:,i) = o_BodyInRoom+R_QuadInRoom*pQuad_InBody(:,i);

pBodyFrame_InRoom = pBodyFrame_InBody;
